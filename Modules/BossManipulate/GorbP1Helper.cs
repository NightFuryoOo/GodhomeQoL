...
public sealed class GorbP1Helper : Module
{
    ...
    {
        gorbP1Phase2Hp = ClampGorbPhase2Hp(gorbP1Phase2Hp, ResolvePhase2MaxHp());
        gorbP1Phase3Hp = ClampGorbPhase3Hp(gorbP1Phase3Hp, gorbP1Phase2Hp);
    }
    ...
    private static void TryForceGorbPhaseTransitions(GameObject bossObject, int currentHp)
    {
        ...
        int phase2Threshold = ClampGorbPhase2Hp(gorbP1Phase2Hp, ResolvePhase2MaxHp());
        int phase3Threshold = ClampGorbPhase3Hp(gorbP1Phase3Hp, phase2Threshold);
    ...
    private static bool ShouldUseCustomHp() => gorbP1UseMaxHp;
    private static bool ShouldUseCustomPhaseThresholds() => gorbP1UseCustomPhase;
    ...
    private static void ApplyPhaseThresholdSettings(PlayMakerFSM fsm)
    {
        ...
        (int phase2Hp, int phase3Hp) thresholds = ShouldUseCustomPhaseThresholds()
            ? (
                ClampGorbPhase2Hp(gorbP1Phase2Hp, phase2MaxHp),
                ClampGorbPhase3Hp(gorbP1Phase3Hp, gorbP1Phase2Hp)
            )
    ...
    private static void ApplyGorbHealth(GameObject boss, HealthManager? hm = null)
    {
        ...
        int targetHp = ClampGorbHp(gorbP1MaxHp);
    ...
    private static int ResolvePhase2MaxHp()
    {
        if (ShouldUseCustomHp())
        {
            return ClampGorbHp(gorbP1MaxHp);
        }
