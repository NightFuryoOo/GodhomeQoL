...
public sealed class UumuuP3Helper : Module
{
    ...
    private static bool ShouldUseCustomHp() => uumuuP3UseMaxHp;
    private static bool ShouldUseCustomSummonHp() => uumuuP3UseCustomSummonHp;
    ...
    private static void ApplyUumuuHealth(GameObject boss, HealthManager? hm = null)
    {
        ...
        int targetHp = ClampUumuuHp(uumuuP3MaxHp);
    ...
    private static void ApplyUumuuSummonHealth(GameObject summon, HealthManager? hm = null)
    {
        ...
        RememberVanillaSummonHp(hm);
        int targetHp = ClampUumuuHp(uumuuP3SummonHp);
