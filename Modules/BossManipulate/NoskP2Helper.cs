...
public sealed class NoskP2Helper : Module
{
    ...
    [LocalSetting]
    internal static int noskP2Phase2Hp = DefaultNoskPhase2Hp;
    ...
    {
        noskP2Phase2Hp = ClampNoskPhase2Hp(noskP2Phase2Hp, ResolvePhase2MaxHp());
    }
    ...
    private static bool ShouldUseCustomHp() => noskP2UseMaxHp;
    private static bool ShouldUseCustomPhaseThreshold() => noskP2UseCustomPhase;
    ...
    private static void ApplyPhaseThresholdSettings(PlayMakerFSM fsm)
    {
        ...
        int threshold = ShouldUseCustomPhaseThreshold()
            ? ClampNoskPhase2Hp(noskP2Phase2Hp, ResolvePhase2MaxHp())
            : GetVanillaPhase2Hp();
    ...
    private static void ApplyNoskHealth(GameObject boss, HealthManager? hm = null)
    {
        ...
        int targetHp = ClampNoskHp(noskP2MaxHp);
    ...
    private static int ResolvePhase2MaxHp()
    {
        if (ShouldUseCustomHp())
        {
            return ClampNoskHp(noskP2MaxHp);
        }
