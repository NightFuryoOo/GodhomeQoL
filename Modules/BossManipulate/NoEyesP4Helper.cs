...
public sealed class NoEyesP4Helper : Module
{
    ...
    {
        noEyesP4Phase2Hp = ClampNoEyesPhase2Hp(noEyesP4Phase2Hp, ResolvePhase2MaxHp());
        noEyesP4Phase3Hp = ClampNoEyesPhase3Hp(noEyesP4Phase3Hp, noEyesP4Phase2Hp);
    }
    ...
    private static void TryForceNoEyesEscalationTransitions(GameObject bossObject, int currentHp)
    {
        ...
        int phase2Threshold = ClampNoEyesPhase2Hp(noEyesP4Phase2Hp, ResolvePhase2MaxHp());
        int phase3Threshold = ClampNoEyesPhase3Hp(noEyesP4Phase3Hp, phase2Threshold);
    ...
    private static bool ShouldUseCustomHp() => noEyesP4UseMaxHp;
    private static bool ShouldUseCustomPhaseThresholds() => noEyesP4UseCustomPhase;
    ...
    private static void ApplyPhaseThresholdSettings(PlayMakerFSM fsm)
    {
        ...
        (int phase2Hp, int phase3Hp) thresholds = ShouldUseCustomPhaseThresholds()
            ? (
                ClampNoEyesPhase2Hp(noEyesP4Phase2Hp, phase2MaxHp),
                ClampNoEyesPhase3Hp(noEyesP4Phase3Hp, noEyesP4Phase2Hp)
            )
    ...
    private static void ApplyNoEyesHealth(GameObject boss, HealthManager? hm = null)
    {
        ...
        int targetHp = ClampNoEyesHp(noEyesP4MaxHp);
    ...
    private static int ResolvePhase2MaxHp()
    {
        if (ShouldUseCustomHp())
        {
            return ClampNoEyesHp(noEyesP4MaxHp);
        }
