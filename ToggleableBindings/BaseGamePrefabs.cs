...
namespace ToggleableBindings
{
    ...
    {
        [System.Diagnostics.CodeAnalysis.NotNull] public static FakePrefab? ChallengeDoorCanvas { get; private set; }

        [System.Diagnostics.CodeAnalysis.NotNull] public static FakePrefab? NailButton { get; private set; }

        [System.Diagnostics.CodeAnalysis.NotNull] public static FakePrefab? ShellButton { get; private set; }

        [System.Diagnostics.CodeAnalysis.NotNull] public static FakePrefab? SoulButton { get; private set; }

        [System.Diagnostics.CodeAnalysis.NotNull] public static FakePrefab? CharmsButton { get; private set; }

        [System.Diagnostics.CodeAnalysis.NotNull] public static FakePrefab? ShopMenu { get; private set; }

        [System.Diagnostics.CodeAnalysis.NotNull] public static FakePrefab? ArrowU { get; private set; }

        [System.Diagnostics.CodeAnalysis.NotNull] public static FakePrefab? ArrowD { get; private set; }

        [System.Diagnostics.CodeAnalysis.NotNull] public static FakePrefab? CharmEquipMsg { get; private set; }
