...
namespace ToggleableBindings
{
    ...
    {
        [System.Diagnostics.CodeAnalysis.NotNull] public static FakePrefab? BindingScroller { get; private set; }

        [System.Diagnostics.CodeAnalysis.NotNull] public static FakePrefab? BindingApplyMsg { get; private set; }
        ...
        private static FakePrefab CreateBindingApplyMsgPrefab()
        {
            return FakePrefab.CreateCopy(BaseGamePrefabs.CharmEquipMsg, nameof(BindingApplyMsg), prefab =>
            {
                ...
                UnityEngine.Object.DestroyImmediate(buttonInfoGO, true);
